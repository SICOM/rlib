...
def rlib_add_datasource_mysql(r, input_name, database_host, database_user, database_password, database_database, port):
    return _rlib.rlib_add_datasource_mysql(r, input_name, database_host, database_user, database_password, database_database, port)
