...
public class rlib {
  ...
  public static int rlib_add_datasource_mysql(SWIGTYPE_p_rlib r, string input_name, string database_host, string database_user, string database_password, string database_database, uint port) {
    int ret = rlibPINVOKE.rlib_add_datasource_mysql(SWIGTYPE_p_rlib.getCPtr(r), input_name, database_host, database_user, database_password, database_database, port);
    return ret;
  }
