...
public class rlib {
  ...
  public static int rlib_add_datasource_mysql_from_group(SWIGTYPE_p_rlib r, String input_name, String group) {
    return rlibJNI.rlib_add_datasource_mysql_from_group(SWIGTYPE_p_rlib.getCPtr(r), input_name, group);
  }
  ...
  public static long rlib_get_output_length(SWIGTYPE_p_rlib r) {
  ...
  public static void rlib_set_radix_character(SWIGTYPE_p_rlib r, char radix_character) {
    rlibJNI.rlib_set_radix_character(SWIGTYPE_p_rlib.getCPtr(r), radix_character);
  }
  ...
  public static void rlib_set_numeric_precision_bits(SWIGTYPE_p_rlib r, int prec) {
    rlibJNI.rlib_set_numeric_precision_bits(SWIGTYPE_p_rlib.getCPtr(r), prec);
  }
