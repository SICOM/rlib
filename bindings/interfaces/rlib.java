...
public class rlib {
  ...
  public static int rlib_add_datasource_mysql(SWIGTYPE_p_rlib r, String input_name, String database_host, String database_user, String database_password, String database_database, long port) {
    return rlibJNI.rlib_add_datasource_mysql(SWIGTYPE_p_rlib.getCPtr(r), input_name, database_host, database_user, database_password, database_database, port);
  }
