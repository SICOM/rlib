...
XS(_wrap_rlib_init) {
  {
    ...
    ST(argvi) = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_rlib, 0 | 0); argvi++ ;
    XSRETURN(argvi);
  fail:
    SWIG_croak_null();
  }
...
XS(_wrap_rlib_add_datasource_mysql) {
  {
    ...
    if ((items < 7) || (items > 7)) {
      SWIG_croak("Usage: rlib_add_datasource_mysql(r,input_name,database_host,database_user,database_password,database_database,port);");
    }
...
XS(_wrap_rlib_signal_connect) {
  {
    ...
    arg2 = (int)(val2);
    {
      int res = SWIG_ConvertFunctionPtr(ST(2), (void**)(&arg3), SWIGTYPE_p_f_p_rlib_p_void__int);
      if (!SWIG_IsOK(res)) {
...
XS(_wrap_rlib_bindtextdomain) {
  {
    ...
    if ((items < 3) || (items > 3)) {
      SWIG_croak("Usage: rlib_bindtextdomain(r,domainname,dirname);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_rlib, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
...
XS(_wrap_rlib_graph) {
  {
    ...
    if ((items < 5) || (items > 5)) {
      SWIG_croak("Usage: rlib_graph(r,part,report,left_margin_offset,top_margin_offset);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_rlib, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
    ...
    arg1 = (rlib *)(argp1);
    res2 = SWIG_ConvertPtr(ST(1), &argp2,SWIGTYPE_p_rlib_part, 0 |  0 );
    if (!SWIG_IsOK(res2)) {
    ...
    res3 = SWIG_ConvertPtr(ST(2), &argp3,SWIGTYPE_p_rlib_report, 0 |  0 );
    if (!SWIG_IsOK(res3)) {
